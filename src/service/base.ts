...
export namespace ServiceBase {
    ...
    export class ServiceBase extends GObject.Object {
        static {
            GObject.registerClass({
                ...
                Signals: {
                    ...
                    "Start": {param_types: [GObject.TYPE_STRING, GObject.TYPE_STRING]},
                    "Stop": {},
                },
            }, this);
        }
        ...
        constructor(properties: ServiceBase.ConstructorProps) {
